...
List<Keluhan> keluhanList = [
  ...
  Keluhan(
      judul: "Demam",
      deskripsi:
          "Tubuh terasa panas, sering disertai dengan gejala tidak nyaman lainnya."),
  Keluhan(
      judul: "Sakit Tenggorokan",
      deskripsi: "Merasakan rasa sakit atau gatal di area tenggorokan."),
  Keluhan(
      judul: "Mual",
      deskripsi:
  ...
  Keluhan(
      judul: "Diare",
      deskripsi:
          "Buang air besar (BAB) dengan tinja encer dan frekuensi yang meningkat."),
  Keluhan(
      judul: "Nyeri Otot",
      deskripsi: "Merasakan nyeri atau kekakuan pada otot-otot tubuh."),
  Keluhan(
      judul: "Insomnia",
      deskripsi: "Kesulitan untuk tidur atau sulit mempertahankan tidur."),
  Keluhan(
      judul: "Stres",
